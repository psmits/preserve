...
% sampling and samplings interaction with other covariates (i.e. geographic range, environmental preference)
%   what's the functional form of how sampling affects observed duration? background etc.
%   my thoughts on sampling are much more akin to ``commonness'' or chance of being observed in any stage during its duration
%     combines preservation and abundance into one value
%     why? 
%   why not do something more like your measure of environmental preference?
...
%Out-of-sample predictive accuracy is a measure of the expected fit of the model to new data. 
