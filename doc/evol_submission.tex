...
%   gap ratio
%   how would this effect duration? no clue
%     assume linear
...
%\begin{table}
%  \caption{Correlation and partial correlation matrices of duration, rescaled and transformed geographic range, and rescaled gap ratio.}
...
%   option is to change to capture-recapture with imperfect detection survival model (like Liow)
%   would effectively only model S(t) but not h(t) slash the whole lifetime distribution
%   i am modeling all of the above: S(t), h(t), and the lifetime distribution!
