...
Fig. 5 caption: change from ‘lower left’ to ‘lower right’. There do not appear to be any numbers that are highlighted in red.}
  ...
  The discussion of environmental preference in the Introduction has been expanded to discuss the mechanisms of differential extinction; see lines 120-132. % CHANGE
  ...
  Addressed in Discussion; see lines 515-530. % CHANGE
  ...
  The Discussion has been adjusted to better couch my results. See lines 508-514. % CHANGE
  ...
  Included in the longer discussion of phylogeny comparative approaches; see lines 576-597. % CHANGE
  ...
  The source and nature of the body size data has now been included in the manuscript; see line 233-235. Also, there is now a discussion of environmental preference as only a single axis in the Discussion; see lines 500-514. % CHANGE
