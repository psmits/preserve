...
\begin{titlepage}
  \begin{large}
    \textbf{Title:} \uppercase{need new title} Temporal variation and correlation of effects of biological traits on brachiopod taxonomic survival
  \end{large}
