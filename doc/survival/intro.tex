...
% brief summary
%   model that takes all of these effects into account simltaneously
%     comparison to previous approaches
%     major improvements
%       taking into account uncertainty in environmental affinity
%       potential age-dependent duration distribution
%       estimating both time varying and time invariant effects
%       model correlation between covariate effects
%   structure controls for multiple comparisons
