...
\begin{equation}
  \begin{aligned}
    ...
    \mu_{k} &\sim \mathcal{N}(0, \exp(\sigma_{\mu})) \\
    \sigma_{k} &\sim \mathcal{N}(0, \varsigma_{\sigma}).
  \end{aligned}
...
\begin{equation}
  \begin{aligned}
    ...
    \omega_{h} &\sim \mathcal{N}(0, \exp(\sigma_{\omega})) \\
    \sigma_{h} &\sim \mathcal{N}(0, \phi_{\sigma})
  \end{aligned}
