...
\begin{frame}
  \begin{block}{Conclusions}
    \begin{itemize}
      \item No effect of body size, environmental preferences equal.
        \begin{itemize}
          \item Very weak support for survival of unspecialized as generalization.
        \end{itemize}
      \item Correlation between effect of geographic range and curvature of effect of environmental preference.
        \begin{itemize}
          \item Effect of geographic range increases, curvature/effect of environmental preference decreases.
        \end{itemize}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item {\footnotesize{David Bapst, \\Ben Frable, \\Graeme Lloyd, \\\textbf{Arnold Miller}, \\Carl Simpson, \\Peter Wagner}}
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
