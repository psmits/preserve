...
\begin{frame}
  ...
  % DJ and Raup statements regarding effects of traits
  %   Wanton versus Fair Game
\end{frame}

\begin{frame}
  \frametitle{Hypotheses}
  % geographic range effect increases while every thing else stays constant.
  % geographic range effect stays constant while every thing else decreases.
\end{frame}
