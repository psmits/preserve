...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width = \textwidth,height = 0.8\textheight,keepaspectratio = true]{figure/intensity_selectivity_no_clue}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{Hypothesis of effect environmental preference and intensity}
  \begin{center}
    \includegraphics[width = \textwidth,height = 0.8\textheight,keepaspectratio = true]{figure/intensity_selectivity_no_clue}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{Hypotheses of effect of environmental breadth and intensity}
  \begin{center}
    \includegraphics[width = \textwidth,height = 0.8\textheight,keepaspectratio = true]{figure/intensity_selectivity_curvature}
  \end{center}
\end{frame}
