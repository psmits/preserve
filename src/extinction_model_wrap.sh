...
#  for i in `seq 1 4`;
#  do
#    /home/psmits/preserve/stan/survival_conalp_nosamp sample num_samples=10000 num_warmup=10000 thin=10 \
#      init=0 \
#      id=$i \
#      data file=$f \
...
do
  for i in `seq 1 4`;
  do
    /home/psmits/preserve/stan/survival_highgrade sample num_samples=10000 num_warmup=10000 thin=10 \
      init=0 \
      id=$i \
      data file=$f \
