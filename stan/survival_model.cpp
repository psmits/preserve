...
namespace survival_model_model_namespace {
...
class survival_model_model : public prob_grad {
private:
    int N;
    int O;
    int R;
    ...
    vector<int> regime;
public:
    survival_model_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        static const char* function__ = "survival_model_model_namespace::survival_model_model(%1%)";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        for (int c = 1; c <= C; ++c) {
            lp_accum__.add(normal_log<propto__>(get_base1(group,c,"group",1), 0, sigma_group));
        }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "survival_model_model_namespace::write_array(%1%)";
        (void) function__; // dummy call to supress warning
    ...
    void write_csv(RNG& base_rng__,
        ...
        stan::io::reader<double> in__(params_r__,params_i__);
        stan::io::csv_writer writer__(o__);
        static const char* function__ = "survival_model_model_namespace::write_csv(%1%)";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        double alpha = in__.scalar_lb_constrain(0);
...
typedef survival_model_model_namespace::survival_model_model stan_model;
